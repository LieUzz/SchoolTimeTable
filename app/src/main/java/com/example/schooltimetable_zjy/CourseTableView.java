...
public class CourseTableView extends RelativeLayout{
    ...
    public CourseTableView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        totalJC = ta.getInt(R.styleable.CourseTable_totalScore, 12);
        ta.recycle();
        init(context);
        drawFrame();
    }
    ...
    private void updateCourseViews() {
        ...
        for (final Course c : coursesData) {
            final int score = c.getClassNumber();
            ...
            flp.setMargins((day - 1) * notFirstEveryColumnsWidth, (score - 1) * notFirstEveryRowHeight, 0, 0);
            fl.setLayoutParams(flp);
            ...
            tv.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (onCourseItemClickListener != null)
                        onCourseItemClickListener.onCourseItemClick((TextView) v, score, day, c.getDes());
                }
            });
            fl.addView(tv);
            myCacheViews.add(fl);
